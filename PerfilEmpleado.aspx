<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="PerfilEmpleado.aspx.cs" Inherits="ProyectoFinal.PerfilEmpleado" %>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="PerfilEmpleado.aspx">Mi Perfil <span class="sr-only">(current)</span></a>
      </li>
     ...
     <tr>
      ...
      <tr>
          <th scope="col">
              ...
              <asp:TextBox ID="txttelefono" runat="server"  onkeypress="return justNumbers(event);" CssClass="form-control input-group" MinLength="9" MaxLength="10" required></asp:TextBox>
       ...
       <tr>
          <th>
              ...
              <asp:Button ID="Button1" runat="server" CssClass="btn btn-success align-content-center" Text="GUARDAR" OnClick="Button1_Click"/>
                  <asp:LinkButton ID="btncancelar" runat="server" Text="Cancelar" class="btn btn-danger" href="PerfilEmpleado.aspx"/>
              </center>
          </th>
      </tr>
