<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="ReporteVentasCajero.aspx.cs" Inherits="ProyectoFinal.ReporteVentasCajero" %>
            ...
            <div class="main-panel">
              ...
              <!-- End Navbar -->
                ...
                <div style=" text-align:center" >
                        <label style="font-family:'Comic Sans MS'; color:brown;font-size:xx-large">REPORTE DE VENTAS</label>
                 </div>
                ...
                <div class="container">
                    ...
                    <asp:TextBox ID="txtpedido" TextMode="Number" runat="server"></asp:TextBox>
                ...
                <div style ="float:left; padding:30px ">
                    ...
                    <asp:ImageButton ID="ImgBtnBuscarNota"  Visible="false" AlternateText="Buscar" ImageUrl="images/buscar.png" runat="server" Height="50px" Width="50px" OnClick="ImgBtnBuscarNota_Click"/>
