<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="ProyectoFinal.Perfil" %>
...
<%--    <div>
  ...
  <a class="navbar-brand" href="AdmMenu.aspx" Font-Bold="true">Inicio</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="Perfil.aspx" Font-Bold="true">Mi Perfil <span class="sr-only">(current)</span></a>
      </li>
      ...
      <tr>
          <th>
              ...
              <asp:Button ID="Button1" runat="server" CssClass="btn btn-success align-content-center" Text="GUARDAR" OnClick="Button1_Click"/>
                  <asp:LinkButton ID="btncancelar" runat="server" Text="Cancelar" class="btn btn-danger" href="Perfil.aspx"/>
              </center>
          </th>
      </tr>
              </table>
