<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="AdministracionClientes.aspx.cs" Inherits="ProyectoFinal.AdministracionClientes" %>
                    ...
                    <div class="col-md-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:LinkButton ID="btncancelar" runat="server" Text="Cancelar" class="btn btn-success pull-right" href="AdministracionClientes.aspx"/>
                        </div>
                      </div>
                    </div>
                  </div>
