<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="AdmAdministracionProductos.aspx.cs" Inherits="ProyectoFinal.AdmAdministracionProductos" %>
               ...
               <br />
                ...
                <div class="content" id="divTable" runat="server">
                 ...
                 <div class="content"  id="divModificar" runat="server" visible="false">
                            ...
                            <asp:LinkButton ID="btncancelar" runat="server" Text="Cancelar" class="btn btn-success pull-right" href="AdmAdministracionProductos.aspx"/>
                      </div>
                    </div>
                  </div>
                </div>
