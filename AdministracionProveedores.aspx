<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="AdministracionProveedores.aspx.cs" Inherits="ProyectoFinal.AdministracionProveedores" %>
                    ...
                    <div class="col-md-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:LinkButton ID="btncancelar" runat="server" Text="Cancelar" class="btn btn-success pull-right" href="AdministracionProveedores.aspx"/>
                        </div>
                      </div>
                    </div>
                  </div>
